...
parser = argparse.ArgumentParser(description='Digital Controlled LC-DCO design generator')
parser.add_argument('--specfile', required=False,
...
parser.add_argument('--platform', required=False,
                    help='PDK/process kit for cadre flow (.e.g sky130)')
...
parser.add_argument('--plot', action='store_true',
                    help='Read and Plot the results.')
