...
shutil.copyfile(flowDir + 'results/' + args.platform + '/scpa/6_final.gds', genDir + args.outputDir + '/' + designName + '.gds')
shutil.copyfile(flowDir + 'results/' + args.platform + '/scpa/6_final.def', genDir + args.outputDir + '/' + designName + '.def')
shutil.copyfile(flowDir + 'results/' + args.platform + '/scpa/6_final.v', genDir + args.outputDir + '/' + designName + '.v')
shutil.copyfile(flowDir + 'results/' + args.platform + '/scpa/6_1_fill.sdc', genDir + args.outputDir + '/' + designName + '.sdc')
...
shutil.copyfile(flowDir + 'reports/' + args.platform + '/scpa/6_final_drc.rpt', genDir + args.outputDir + '/6_final_drc.rpt')
shutil.copyfile(flowDir + 'reports/' + args.platform + '/scpa/6_final_lvs.rpt', genDir + args.outputDir + '/6_final_lvs.rpt')
