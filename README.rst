...
Please install the following tools with the recommended commit ids for a stable functioning of the flow:
  ...
  4. `Yosys <https://github.com/The-OpenROAD-Project/yosys>`_ (version:0.19+36)

  5. `OpenROAD <https://github.com/The-OpenROAD-Project/OpenROAD>`_ (version:2.0_4532)

  6. `Open_pdks <https://github.com/RTimothyEdwards/open_pdks>`_ (version:1.0.321)
