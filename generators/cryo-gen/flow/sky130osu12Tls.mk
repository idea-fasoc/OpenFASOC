...
PUBLIC=sky130hd sky130hs sky130hvl sky130osu12Ths sky130osu12Tls
...
$(RESULTS_DIR)/2_floorplan_ro.def: $(RESULTS_DIR)/2_floorplan.def
	python3 util/place_ro.py --inputDef $(RESULTS_DIR)/2_floorplan.def --outputDef $(RESULTS_DIR)/2_floorplan_ro.def --coreDim 50,40 --arrayDim 24,6 --cellDim 0.99,4.44 --targetInst cryo_ro_1 --coreDieOffset 3.63,4.44
