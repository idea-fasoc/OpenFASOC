...
if args.platform != 'sky130hd' and args.platform != 'sky130hs' and args.platform != 'sky130hvl' and args.platform != 'sky130osu12Ths' and args.platform != 'sky130osu12Tms' and args.platform != 'sky130osu18Ths':
  print("Error: only sky130hd, sky130hs, sky130hvl, sky130osu12Ths/ms, and sky130osu18Ths platforms are supported as of now")
  sys.exit(1)
