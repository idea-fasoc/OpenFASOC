...
parser.add_argument('--via_sets', required=True,
                    help='Number of via segments divided horizontally (EVEN)')
parser.add_argument('--seg_length', required=True,
                    help='Length of segment (between two vias)')
parser.add_argument('--seg_width', required=True,
                    help='Width of segment')
parser.add_argument('--via_dim', required=True,
                    help='Dimension of Via W & L')
...
r = Cvia << gf.components.rectangle(size=[seg_width, seg_width], layer=(wire_layer-1,20))
