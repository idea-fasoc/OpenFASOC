...
#set region [$block findRegion "mimcaptut_array"]
...
foreach inst [$block getInsts] {
  if {[[$inst getMaster] getName] == "mimcaptut"} {
    $inst setOrigin 6 6
  }
}
...
#
#set allInst [$block getInsts]

#foreach inst $allinsts {
#  set master [$inst getMaster]
#  set name [$inst getName]
#  if {[string match "mimcaptut" $name]} {
