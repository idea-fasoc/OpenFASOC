...
parser = argparse.ArgumentParser(
    description="the config-gen for Programmable Switched-Cap DC-DC generator"
)
parser.add_argument(
    "--specfile",
    required=True,
...
if jsonSpec["generator"] != "dcdc-config-gen":
    print('Error: Generator specification must be "dcdc-config-gen".')
    sys.exit(1)
