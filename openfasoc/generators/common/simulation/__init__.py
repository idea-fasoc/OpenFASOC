...
def run_simulations(
    ...
    - `platform` (str): Command for the simulation tool. (Currently only supports `ngspice`)
    ...
    - `sim_tool` (str = "sim_tool"): Command for the simulation tool. (Currently only supports `ngspice`)
