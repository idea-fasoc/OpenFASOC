...
## global connections
#####################################
add_global_connection  -net VDD -inst_pattern {.*} -pin_pattern {VPWR|VPB} -power
...
add_pdn_stripe -grid grid -layer met1 -width 0.48 -pitch 5.44 -offset 0 -extend_to_core_ring -followpins
