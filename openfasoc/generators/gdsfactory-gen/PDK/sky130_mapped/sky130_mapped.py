...
grulesobj["dnwell"]["dnwell"] = {'min_width': 1.7, 'min_seperation': 5.42}
grulesobj["dnwell"]["pwell"] = {'min_enclosure': 2.5}
grulesobj["dnwell"]["nwell"] = {'min_seperation': 3.1, 'min_enclosure': 0.5}
grulesobj["dnwell"]["p+s/d"] = {}
grulesobj["dnwell"]["n+s/d"] = {}
grulesobj["dnwell"]["active_diff"] = {'min_enclosure': 0.93}
grulesobj["dnwell"]["active_tap"] = {'min_enclosure': 0.62, 'min_seperation': 2.5}
...
grulesobj["pwell"]["pwell"] = {'min_width': 0.6, 'min_seperation': 1.4}
grulesobj["pwell"]["nwell"] = {'min_seperation': 0.0}
...
grulesobj["nwell"]["nwell"] = {'min_width': 0.86, 'min_seperation': 1.4}
...
grulesobj["p+s/d"]["p+s/d"] = {'min_width': 0.4, 'min_seperation': 0.4}
...
grulesobj["n+s/d"]["n+s/d"] = {'min_width': 0.4, 'min_seperation': 0.4}
...
grulesobj["active_diff"]["active_tap"] = {'0.3)': '*****FIXTHIS!!!MANUALLY!*****', 'min_seperation': 0.28, 'max_seperation': 20.0}
grulesobj["active_diff"]["poly"] = {'overhang': 0.24, 'min_seperation': 0.1}
...
grulesobj["active_tap"]["active_tap"] = {'min_width': 0.22, 'min_seperation': 0.28}
grulesobj["active_tap"]["poly"] = {'min_seperation': 0.1}
...
grulesobj["poly"]["mcon"] = {'min_enclosure': 0.07, 'min_seperation': 0.17}
grulesobj["poly"]["met1"] = {}
grulesobj["poly"]["via1"] = {}
grulesobj["poly"]["met2"] = {}
grulesobj["poly"]["via2"] = {}
...
grulesobj["mcon"]["poly"] = {}
grulesobj["mcon"]["mcon"] = {'min_seperation': 0.28, 'width': 0.22}
...
grulesobj["met1"]["poly"] = {}
grulesobj["met1"]["mcon"] = {}
grulesobj["met1"]["met1"] = {'min_width': 0.23, 'min_seperation': 0.3}
...
grulesobj["via1"]["mcon"] = {}
grulesobj["via1"]["met1"] = {}
grulesobj["via1"]["via1"] = {'width': 0.26, 'min_seperation': 0.36}
...
grulesobj["met2"]["met1"] = {}
grulesobj["met2"]["via1"] = {}
grulesobj["met2"]["met2"] = {'min_width': 0.28, 'min_seperation': 0.3}
...
grulesobj["via2"]["via1"] = {}
grulesobj["via2"]["met2"] = {}
grulesobj["via2"]["via2"] = {'width': 0.26, 'min_seperation': 0.36}
...
grulesobj["met3"]["met2"] = {}
grulesobj["met3"]["via2"] = {}
grulesobj["met3"]["met3"] = {'min_width': 0.28, 'min_seperation': 0.3}
...
grulesobj["via3"]["via2"] = {}
grulesobj["via3"]["met3"] = {}
grulesobj["via3"]["via3"] = {'width': 0.26, 'min_seperation': 0.36}
...
grulesobj["met4"]["met3"] = {}
grulesobj["met4"]["via3"] = {}
grulesobj["met4"]["met4"] = {'min_width': 0.28, 'min_seperation': 0.3}
