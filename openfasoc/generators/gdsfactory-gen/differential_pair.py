...
def nmos(cell_height) -> Component:
    ...
    met1_label_s = c.add_label("S", position=(0.255,(cell_height/2)), layer=met1_label, magnification=0.2)
    met1_label_d = c.add_label("D", position=(0.81,(cell_height/2)), layer=met1_label, magnification=0.2)
    #c.add_label()
    ...
    for i in range(mult):
        ...
        #for j in range(2):
            ...
            if i == 0:
                ...
                ref.movex(cell_width*i - (cell_width*i/2)).movey(cell_height*(j) + space_bet_rows*(j))
