...
class bjt(nmos.nmos18_device):
    ...
    def __init__(self, layout, device_name, guard_ring=1):
        ...
        self.l_guard = self.layout.layer(psdm_lay_num, psdm_lay_dt)
    ...
    def draw_bjt(self):
        ...
        enlarge_value = int(
            (bjt.n_well_diffusion_spacing + bjt.tap_width / 2) * self.percision
        )
        self.bjt_bbox = (
            self.layout.cell(self.cell_name)
            .bbox()
            .enlarge(enlarge_value, enlarge_value)
        )
        ...
        if self.gr:
            self.draw_guard_ring(
                ...
                tap_width=bjt.tap_width,
                cell=self.layout.cell(self.cell_name),
