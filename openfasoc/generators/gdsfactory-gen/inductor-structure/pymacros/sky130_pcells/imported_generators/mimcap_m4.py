...
class mimcap_m4:
    ...
    def draw_cap(self):
        ...
        met5_center_box = mimcap_box.enlarge(
            -1 * mimcap_m4.mimcap_enc_metal5 * self.percision,
            -1 * mimcap_m4.mimcap_enc_metal5 * self.percision,
        )
        pin0_text = pya.Text(
            self.pin0, met5_center_box.center().x, met5_center_box.center().y
        )
        ...
        met4_box = pya.Box(
            ...
            + self.w
            + mimcap_m4.metal4_margin_right * self.percision,
        ...
        met5_side_box = pya.Box(
            prbndry_box.p2.x + mimcap_m4.met5_side_pr_spacing * self.percision,
            prbndry_box.p1.y,
            prbndry_box.p2.x
            + mimcap_m4.met5_side_pr_spacing * self.percision
            + mimcap_m4.met5_side_width * self.percision,
            prbndry_box.p2.y,
        )

        pin1_text = pya.Text(
            self.pin1, met5_side_box.center().x, met5_side_box.center().y
        )
