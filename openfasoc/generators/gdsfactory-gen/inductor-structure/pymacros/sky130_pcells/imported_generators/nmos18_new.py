...
class nmos18_device:
    def __init__(
        ...
        self.npsdm_enc_diff = 0.125 * self.percision
    ...
    def draw_guard_ring(
        ...
        npsdm_enc_diff = 0.125 * PERCISION
        ...
        guard_ring_path = pya.Path(
            [
                guard_ring_lower_left,
                guard_ring_upper_left,
                guard_ring_upper_right,
                guard_ring_lower_right,
                guard_ring_lower_left,
            ],
            tap_width,
            tap_width / 2,
        ...
        psdm_guard_ring_path = pya.Path(
            ...
            tap_width + 2 * npsdm_enc_diff,
            (tap_width + 2 * npsdm_enc_diff) / 2,
            0,
        )
        gurad_ring_metal1_upper = pya.Path(
            [guard_ring_upper_left, guard_ring_upper_right],
            tap_width,
            tap_width / 2,
            tap_width / 2,
        )
        cell.shapes(l_met1).insert(gurad_ring_metal1_upper)
        gurad_ring_metal1_lower = pya.Path(
            [guard_ring_lower_left, guard_ring_lower_right],
            tap_width,
            tap_width / 2,
            tap_width / 2,
        )
        cell.shapes(l_met1).insert(gurad_ring_metal1_lower)
        gurad_ring_metal1_right = pya.Path(
            [guard_ring_lower_right, guard_ring_upper_right],
            tap_width,
            tap_width / 2,
            tap_width / 2,
        )
        cell.shapes(l_met1).insert(gurad_ring_metal1_right)
        gurad_ring_metal1_left = pya.Path(
            [guard_ring_lower_left, guard_ring_upper_left],
            tap_width,
            tap_width / 2,
            tap_width / 2,
        )
        ...
        distance_cont_guard_vert_licon = (
            guard_ring_upper_left.y
            - guard_ring_lower_left.y
            - licon_size
            - 2 * licon_size
        )
        num_licon_guard_vert, free_spc_licon_guard_left = self.number_spc_contacts(
            distance_cont_guard_vert_licon, mcon_m1_enc, licon_size, licon_size
        )
        licon_guard_p1_x_left = guard_ring_lower_left.x - licon_size / 2
        licon_guard_p1_x_right = guard_ring_lower_right.x - licon_size / 2
        licon_guard_p1_y = (
            guard_ring_lower_left.y
            + free_spc_licon_guard_left / 2
            + licon_size / 2
            + licon_size
        )
        ...
        for licon in range(num_licon_guard_vert):
            licon_guard_box_left = pya.Box(
                licon_guard_p1_x_left,
                licon_guard_p1_y,
                licon_guard_p2_x_left,
                licon_guard_p2_y,
            )
            licon_guard_box_right = pya.Box(
                licon_guard_p1_x_right,
                licon_guard_p1_y,
                licon_guard_p2_x_right,
                licon_guard_p2_y,
            )
        ...
        distance_cont_guard_vert_mcon = (
            guard_ring_upper_left.y - guard_ring_lower_left.y - mcon_size - 2 * mcon_spc
        )
        num_mcon_guard_vert, free_spc_mcon_guard_left = self.number_spc_contacts(
            distance_cont_guard_vert_mcon, mcon_m1_enc, mcon_spc, mcon_size
        )
        mcon_guard_p1_x_left = guard_ring_lower_left.x - mcon_size / 2
        mcon_guard_p1_x_right = guard_ring_lower_right.x - mcon_size / 2
        mcon_guard_p1_y = (
            guard_ring_lower_left.y
            + free_spc_mcon_guard_left / 2
            + mcon_size / 2
            + mcon_spc
        )
        ...
        for mcon in range(num_mcon_guard_vert):
            mcon_guard_box_left = pya.Box(
                mcon_guard_p1_x_left,
                mcon_guard_p1_y,
                mcon_guard_p2_x_left,
                mcon_guard_p2_y,
            )
            mcon_guard_box_right = pya.Box(
                mcon_guard_p1_x_right,
                mcon_guard_p1_y,
                mcon_guard_p2_x_right,
                mcon_guard_p2_y,
            )
        ...
        distance_cont_guard_vert_via = (
            guard_ring_upper_left.y - guard_ring_lower_left.y - via_size - 2 * via_spc
        )
        num_via_guard_vert, free_spc_via_guard_left = self.number_spc_contacts(
            distance_cont_guard_vert_via, via_met_enc, via_spc, via_size
        )
        via_guard_p1_x_left = guard_ring_lower_left.x - via_size / 2
        via_guard_p1_x_right = guard_ring_lower_right.x - via_size / 2
        via_guard_p1_y = (
            guard_ring_lower_left.y
            + free_spc_via_guard_left / 2
            + via_size / 2
            + via_spc
        )
        ...
        for via in range(num_via_guard_vert):
            via_guard_box_left = pya.Box(
                via_guard_p1_x_left, via_guard_p1_y, via_guard_p2_x_left, via_guard_p2_y
            )
            via_guard_box_right = pya.Box(
                via_guard_p1_x_right,
                via_guard_p1_y,
                via_guard_p2_x_right,
                via_guard_p2_y,
            )
        ...
        distance_cont_guard_hori = (
            guard_ring_upper_right.x - guard_ring_upper_left.x
        ) - 2 * mcon_spc
        num_licon_guard_hori, free_spc_licon_guard_hori = self.number_spc_contacts(
            distance_cont_guard_hori, mcon_m1_enc, licon_size, licon_size
        )
        licon_guard_p1_x_hori = (
            guard_ring_lower_left.x + free_spc_licon_guard_hori / 2 + mcon_spc
        )
        ...
        for licon in range(num_licon_guard_hori):
            licon_guard_box_upper = pya.Box(
                licon_guard_p1_x_hori,
                licon_guard_p1_y_upper,
                licon_guard_p2_x_hori,
                licon_guard_p2_y_upper,
            )
            licon_guard_box_lower = pya.Box(
                licon_guard_p1_x_hori,
                licon_guard_p1_y_lower,
                licon_guard_p2_x_hori,
            ...
            num_mcon_guard_hori, free_spc_mcon_guard_hori = self.number_spc_contacts(
                distance_cont_guard_hori, mcon_m1_enc, mcon_spc, mcon_size
            )
            mcon_guard_p1_x_hori = (
                guard_ring_lower_left.x + free_spc_mcon_guard_hori / 2 + mcon_spc
            )
            ...
            for mcon in range(num_mcon_guard_hori):
                mcon_guard_box_upper = pya.Box(
                    mcon_guard_p1_x_hori,
                    mcon_guard_p1_y_upper,
                    mcon_guard_p2_x_hori,
                    mcon_guard_p2_y_upper,
                )
                mcon_guard_box_lower = pya.Box(
                    mcon_guard_p1_x_hori,
                    mcon_guard_p1_y_lower,
                    mcon_guard_p2_x_hori,
            ...
            num_via_guard_hori, free_spc_via_guard_hori = self.number_spc_contacts(
                distance_cont_guard_hori, via_met_enc, via_spc, via_size
            )
            via_guard_p1_x_hori = (
                guard_ring_lower_left.x + free_spc_via_guard_hori / 2 + via_spc
            )
            ...
            for via in range(num_via_guard_hori):
                via_guard_box_upper = pya.Box(
                    via_guard_p1_x_hori,
                    via_guard_p1_y_upper,
                    via_guard_p2_x_hori,
                    via_guard_p2_y_upper,
                )
                via_guard_box_lower = pya.Box(
                    via_guard_p1_x_hori,
                    via_guard_p1_y_lower,
                    via_guard_p2_x_hori,
            ...
            if guard_label != "":
                guard_connection_text = pya.Text(
                    guard_label,
    ...
    def draw_diffusion_box(self):
        ...
        self.diffusion_width = (
            self.dsa * self.mcon_size
            + (self.dsa - 1) * self.mcon_spc
            + 2 * self.liconpoly_spc
        )
        self.channel_length = self.l * self.percision

        # total diffusion width including gates
        self.diffusion_total_width = (
            self.nf * self.channel_length
            + (self.nf - 1) * self.diffusion_width
            + 2 * self.diffusion_width
        )
        self.channel_width = self.w * self.percision
        self.diff_box = pya.Box(0, 0, self.diffusion_total_width, self.channel_width)
        self.npsdm_enc_diff = 0.125 * self.percision
    ...
    def draw_gates(self):
        ...
        for finger in range(self.nf):
            gate_box = pya.Box(
                self.diffusion_width + x,
                -self.poly_diff_min_enc,
                self.channel_length + self.diffusion_width + x,
        ...
        free_spc_licon_gate = (
            contact_gate_width - (2 * num_horizontal_licon_gate - 1) * self.licon_size
        )
        if self.channel_length > contact_gate_width:
            ...
            num_horizontal_licon_gate, free_spc_licon_gate = self.number_spc_contacts(
                self.channel_length,
                self.liconpoly_enc_horizontal,
                self.licon_size,
                self.licon_size,
            )
        elif (
            self.channel_length < contact_gate_width and self.nf != 1 and self.dsa == 1
        ):
            self.connection = 2
        ...
        npc_box_down = pya.Box(
            contact_gate_box_down.p1.x - self.npc_enc_gate,
            contact_gate_box_down.p1.y - self.npc_enc_gate,
            contact_gate_box_down.p2.x + self.npc_enc_gate,
            contact_gate_box_down.p2.y + self.npc_enc_gate,
        )
        li_box_down = pya.Box(
            self.diff_box.p1.x,
            contact_gate_box_down.p1.y,
            self.diff_box.p1.x
            + self.multipliers * self.diffusion_total_width
            + (2 * self.multipliers - 2) * self.npsdm_enc_diff
            + (self.multipliers - 1) * self.npsdm_spc,
            contact_gate_box_down.p2.y,
        )

        self.gate_connection_text_down = pya.Text(
            self.gate_connection_text_up, li_box_down.center().x, li_box_down.center().y
        )

        self.contact_gate_box_up = pya.Box(
            gate_box.center().x - contact_gate_width / 2,
            self.channel_width + self.polylicon_spc_diff,
            gate_box.center().x + contact_gate_width / 2,
            self.channel_width + self.polylicon_spc_diff + contact_gate_height,
        )
        self.neck_box_up = pya.Box(
            self.diffusion_width,
            self.channel_width + self.poly_diff_min_enc,
            self.channel_length + self.diffusion_width,
            self.channel_width + self.polylicon_spc_diff,
        )
        self.licon_box_up = pya.Box(
            self.contact_gate_box_up.center().x - self.licon_size / 2,
            self.contact_gate_box_up.center().y - (self.licon_size / 2),
            self.contact_gate_box_up.center().x + self.licon_size / 2,
            self.contact_gate_box_up.center().y + self.licon_size / 2,
        )
        self.npc_box_up = pya.Box(
            self.contact_gate_box_up.p1.x - 1.6 * self.npc_enc_gate,
            self.contact_gate_box_up.p1.y - self.npc_enc_gate,
            self.contact_gate_box_up.p2.x + 1.6 * self.npc_enc_gate,
            self.contact_gate_box_up.p2.y + self.npc_enc_gate,
        )

    def between_fingers_connection(self):
        if self.nf:
            licon_between_fingers_arr = pya.CellInstArray(
                self.licon_between_fingers_cell.cell_index(),
                pya.Trans(pya.Point(0, 0)),
                pya.Vector(0, 2 * self.licon_size),
                pya.Vector(self.diffusion_width + self.channel_length, 0),
                self.num_ver_licon,
                self.nf + 1,
            )
        ...
        if self.nf:
            li_between_fingers_arr = pya.CellInstArray(
                self.li_between_fingers_cell.cell_index(),
                pya.Trans(pya.Point(0, 0)),
                pya.Vector(self.diffusion_width + self.channel_length, 0),
                pya.Vector(0, 0),
                self.nf + 1,
        ...
        if self.nf:
            mcon_diff_bet_fing = pya.CellInstArray(
                self.mcon_between_fingers_cell.cell_index(),
                pya.Trans(pya.Point(0, 0)),
                pya.Vector(self.diffusion_width + self.channel_length, 0),
                pya.Vector(0, self.mcon_spc + self.mcon_size),
                self.nf + 1,
                self.num_ver_mcon,
            )
    ...
    def guard_ring_points(self):
        ...
        guard_ring_lower_left = pya.Point(
            self.diff_box.p1.x
            - 2 * self.npsdm_enc_diff
            - self.npsdm_spc_opposite
            - tap_width / 2,
            guard_down
            - 2 * self.npsdm_enc_diff
            - self.npsdm_spc_opposite
        ...
        guard_ring_upper_left = pya.Point(
            guard_ring_lower_left.x,
            guard_up
            + 2 * self.npsdm_enc_diff
            + self.npsdm_spc_opposite
            + tap_width / 2,
        ...
        guard_ring_upper_right = pya.Point(
            self.multipliers * self.diffusion_total_width
            + 2 * self.multipliers * self.npsdm_enc_diff
            + (self.multipliers - 1) * self.npsdm_spc
            + self.npsdm_spc_opposite
            + tap_width / 2,
            guard_ring_upper_left.y,
        ...
        guard_ring_width = (
            guard_ring_lower_right.x - guard_ring_lower_left.x
        ) / self.percision
        guard_ring_height = (
            guard_ring_upper_right.y - guard_ring_lower_right.y
        ) / self.percision
        ...
        if self.gr:
            ...
            self.draw_guard_ring(
                layout=self.layout,
                x=guard_ring_lower_left.x,
                y=guard_ring_lower_left.y,
                guard_width=guard_ring_width,
                guard_height=guard_ring_height,
    ...
    def choose_gate_connection_top_bottom(self):
        ...
        if self.connection == 1 or self.connection == 2:
            ...
            self.nmos_cell.shapes(self.l_met1_label).insert(gate_connection_text_down)
            ...
            for mcon in range(num_hor_mcon_gates):
                ...
                for mcon1 in range(num_ver_mcon_gates - 1):
                    ...
                    self.nmos_cell.shapes(self.l_mcon).insert(mcon_box_gate)
                y_mcon_gates -= (num_ver_mcon_gates - 1) * mcon_size + (
                    num_ver_mcon_gates - 1
                ) * mcon_spc
                y1_mcon_gates -= (num_ver_mcon_gates - 1) * mcon_size + (
                    num_ver_mcon_gates - 1
                ) * mcon_spc
        ...
        if self.connection == 0 or self.connection == 2:
            ...
            li_box_up = pya.Box(
                diff_box.p1.x,
                contact_gate_box_up.p1.y,
                diff_box.p1.x
                + multipliers * diffusion_total_width
                + (2 * multipliers - 2) * npsdm_enc_diff
                + (multipliers - 1) * npsdm_spc,
                contact_gate_box_up.p2.y,
            )

            gate_connection_text_up = pya.Text(
                gate_connection_text_up, li_box_up.center().x, li_box_up.center().y
            )
        ...
        self.mcon_between_fingers_cell.shapes(self.l_mcon).insert(
            self.mcon_between_fingers
        )

        self.li_between_fingers_cell.shapes(self.l_li).insert(
            self.li_between_fingers_path
        )
        self.li_between_fingers_cell.shapes(self.l_met1).insert(
            self.met1_between_fingers_path
        )
        ...
        iteration_distance_group = (
            2 * self.n * (self.diffusion_width + self.channel_length)
        )
        if self.connection == 1:  # for gate_connection_down_only
            ...
            bottom_connection = pya.CellInstArray(
                down_gate_connection.cell_index(),
                pya.Trans(pya.Point(0, 0)),
                pya.Vector(down_iteration_distance, 0),
                pya.Vector(iteration_distance_group, 0),
                down_iteration,
            ...
            upper_connection = pya.CellInstArray(
                self.up_gate_connection.cell_index(),
                pya.Trans(pya.Point(shift_distance, 0)),
            ...
            bottom_connection = pya.CellInstArray(
                self.down_gate_connection.cell_index(),
                pya.Trans(pya.Point(0, 0)),
                pya.Vector(down_iteration_distance, 0),
                pya.Vector(iteration_distance_group, 0),
                down_iteration,
    ...
    def draw_drain_source_connection(self):
        ...
        self.num_ver_licon, self.free_space_diff_licon = self.number_spc_contacts(
            self.channel_width,
            self.diff_licon_enc_vertical,
            self.licon_spc,
            self.licon_size,
        )
        ...
        num_hori_licon_diff, free_space_licon_diff_hor = self.number_spc_contacts(
            self.diffusion_width, self.liconpoly_spc, self.licon_size, self.licon_size
        )

        sh1 = 0
        for hor_licon_diff in range(num_hori_licon_diff):
            licon_between_fingers = pya.Box(
                free_space_licon_diff_hor / 2 + sh1,
                self.free_space_diff_licon / 2,
                free_space_licon_diff_hor / 2 + self.licon_size + sh1,
                self.free_space_diff_licon / 2 + self.licon_size,
            )
            self.licon_between_fingers_cell.shapes(self.l_licon).insert(
        ...
        for hor_mcon_diff in range(num_hori_mcon_diff):
            mcon_between_fingers = pya.Box(
                free_space_mcon_diff_hor / 2 + sh2,
        ...
        li_between_fingers_path = pya.Path(
            [
                pya.Point(self.diffusion_width / 2, self.diff_box.p1.y),
                pya.Point(self.diffusion_width / 2, self.diff_box.p2.y),
            ],
            self.diffusion_width - self.li_width_reduction,
        )
        met1_between_fingers_path = pya.Path(
            [
                pya.Point(
                    self.diffusion_width / 2, self.diff_box.p1.y - self.mcon_m1_enc
                ),
                pya.Point(
                    self.diffusion_width / 2, self.diff_box.p2.y + self.mcon_m1_enc
                ),
            ],
            self.diffusion_width,
        )
        met1_diff_left = pya.Path(
            [
                pya.Point(
                    self.licon_diff_contact_left.center().x,
                    self.diff_box.p1.y - self.mcon_m1_enc,
                ),
                pya.Point(
                    self.licon_diff_contact_left.center().x,
                    self.diff_box.p2.y + self.mcon_m1_enc,
                ),
            ],
        ...
        for drain in range(math.ceil((self.nf + 1) / 2)):
            drain_connection_text = pya.Text(
                self.drain_connection_text_input,
        ...
        for source in range(((self.nf + 1) - math.ceil((self.nf + 1) / 2))):
            source_connection_text = pya.Text(
                self.source_connection_text_input,
        ...
        mcon_diff_left = pya.Box(
            self.licon_diff_contact_left.p1.x,
            0,
            self.licon_diff_contact_left.p1.x + self.mcon_size,
            self.mcon_size,
        )

        licon_diff_contact_right = pya.Box(
            self.diff_box.p2.x - self.diff_licon_enc_horzintal - self.licon_size,
            self.free_space_diff_licon / 2,
            self.diff_box.p2.x - self.diff_licon_enc_horzintal,
            self.free_space_diff_licon / 2 + self.licon_size,
        )
        li_diff_right = pya.Path(
            [
                pya.Point(licon_diff_contact_right.center().x, self.diff_box.p1.y),
                pya.Point(licon_diff_contact_right.center().x, self.diff_box.p2.y),
            ],
            self.li_width,
        )
        mcon_diff_right = pya.Box(
            licon_diff_contact_right.p1.x,
            0,
            licon_diff_contact_right.p1.x + self.mcon_size,
            self.mcon_size,
        )
        met1_diff_right = pya.Path(
            [
                pya.Point(
                    licon_diff_contact_right.center().x,
                    self.diff_box.p1.y - self.mcon_m1_enc,
                ),
                pya.Point(
                    licon_diff_contact_right.center().x,
    ...
    def draw_nmos(self):
        ...
        if self.gate_connection_up == "gate_connection_up_":
            self.gate_connection_text_up = self.gate_connection_up + str(self.conn_num)
        else:
            self.gate_connection_text_up = self.gate_connection_up

        if self.gate_connection_down == "gate_connection_down_":
            self.gate_connection_text_down = self.gate_connection_down + str(
                self.conn_num
            )
        else:
        ...
        if self.gate_connection == "gate_connection_":
            self.gate_connection_text_down = self.gate_connection + str(self.conn_num)
            self.gate_connection_text_up = self.gate_connection + str(self.conn_num)
        else:
        ...
        diffusion_width = (
            self.dsa * mcon_size + (self.dsa - 1) * mcon_spc + 2 * liconpoly_spc
        )
        ...
        diffusion_total_width = (
            self.nf * channel_length
        ...
        # number of vertical licon's diff
        num_ver_licon, free_space_diff_licon = self.number_spc_contacts(
            channel_width, diff_licon_enc_vertical, licon_spc, licon_size
        )
        # number of vertical mcon diff
        num_ver_mcon, free_spc_mcon_diff = self.number_spc_contacts(
        ...
        self.li_between_fingers_cell = self.layout.create_cell("li_between_fingers")
        self.mcon_between_fingers_cell = self.layout.create_cell("mcon_between_fingers")
