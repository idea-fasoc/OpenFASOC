...
def opamp(
    ...
    pmos_comps_ref.movey(ydim_ncomps + pmos_comps_ref.ymax+8)
    ...
    opamp_top << L_route(pdk, mimcaps_ref.ports["bottom_met_S"], set_orientation(n_to_p_output_route.ports["con_S"],"E"), hwidth=3)
    # TODO: implement
