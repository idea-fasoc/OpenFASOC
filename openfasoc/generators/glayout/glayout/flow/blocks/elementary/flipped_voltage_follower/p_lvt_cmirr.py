...
def pmos_lvt_cmirror(     
    ...
    top_level << c_route(pdk, drain_A1_via.ports["bottom_met_N"], drain_A2_via.ports["bottom_met_N"], extension=1.5, e1glayer='met3', e2glayer='met3', cglayer='met2')
    ...
    component.info['netlist'] = pmos_lvt_cmirror_netlist(pdk, width/2, length, fingers, multipliers)
