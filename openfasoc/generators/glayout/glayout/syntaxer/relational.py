...
class ImportCell(GlayoutAction):
    ...
    def test(cls):
        tests = list()
        tests.append([["nmos","nfet"],"nmos","glayout.flow.components.primitives.fet.fet"])
        tests.append([["pmos","pfet"],"pmos","glayout.flow.components.primitives.fet.fet"])
        tests.append([["guardring","tapring","welltap","well tap", "tap ring"],"tapring","glayout.flow.components.primitives.guardring.guardring"])
        tests.append([["mimcap"],"mimcap","glayout.flow.components.primitives.mimcap.mimcap"])
        tests.append([["mimcap array","mimcaparray","mimcap_array"],"mimcap_array","glayout.flow.components.primitives.mimcap.mimcap"])
        tests.append([["via","via stack","via_stack"],"via_stack","glayout.flow.components.primitives.via_gen.via_gen"])
        tests.append([["via array","via_array"],"via_array","glayout.flow.components.primitives.via_gen.via_gen"])
...
class GlayoutCode(GlayoutAction):
    ...
    def __init__(self, toplvl_name: str):
        ...
        self.update_import_table(["diff pair","diff_pair","differential pair","differential pairs","differential transistor"],"diff_pair_generic","glayout.flow.components.primitives.diff_pair")
