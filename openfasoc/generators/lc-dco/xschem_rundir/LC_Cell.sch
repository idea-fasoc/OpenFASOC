...
N 320 -415 320 -275 { lab=outn}
N 320 -239 409 -239 { lab=swcap[7:0]}
N 320 -275 320 -255 { lab=outn}
N 409 -239 474 -239 { lab=swcap[7:0]}
...
C {swcap_3M2C_scaled.sym} 170 -255 0 0 {name=x1}
C {devices/lab_pin.sym} 320 -327 0 1 {name=l6 sig_type=std_logic lab=outn
}
C {devices/lab_pin.sym} 20 -320 0 0 {name=l7 sig_type=std_logic lab=outp}
C {devices/ipin.sym} 474 -239 0 1 {name=p4 lab=swcap[7:0]
}
...
C {devices/gnd.sym} 170 -205 0 0 {name=l5 lab=GND}
