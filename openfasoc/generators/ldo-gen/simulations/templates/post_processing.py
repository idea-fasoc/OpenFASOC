...
for i in range(cap_len):
 ...
 print('Time to reach stable VREG for' + ' ' + str(cap_list[i])+' is' + ' ' + str(time_sample_dev[0]))
 print('VREG oscillation at output for' + ' ' + str(cap_list[i])+' is' + ' ' + str(VREG_dev))
 print('VREG max oscillation at output for' + ' ' + str(cap_list[i])+' is' + ' ' + str(VREG_sample_dev_max))
 print('VREG min oscillation at output for' + ' ' + str(cap_list[i])+' is' + ' ' + str(VREG_sample_dev_min))
