...
gpio0_addr = (
    "ftdi://ftdi:232h:"
    + hex(FT232H_list[0][0].bus)[2:].zfill(2)
    + ":"
    + hex(FT232H_list[0][0].address)[2:].zfill(2)
    + "/1"
)
gpio1_addr = (
    "ftdi://ftdi:232h:"
    + hex(FT232H_list[1][0].bus)[2:].zfill(2)
    + ":"
    + hex(FT232H_list[1][0].address)[2:].zfill(2)
    + "/1"
)
gpio2_addr = (
    "ftdi://ftdi:232h:"
    + hex(FT232H_list[2][0].bus)[2:].zfill(2)
    + ":"
    + hex(FT232H_list[2][0].address)[2:].zfill(2)
    + "/1"
)
